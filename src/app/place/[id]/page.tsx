  ...
  return (
    <main className="min-h-screen bg-[#0B0E14] text-slate-200 p-4 sm:p-8 pb-20">
      <div className="max-w-5xl mx-auto">
        ...
        {/* Game Header */}
        <div className="bg-[#151921] rounded-2xl p-6 border border-slate-800 mb-8 flex flex-col md:flex-row gap-8 shadow-xl shadow-black/20">
          ...
          <div className="flex-1 flex flex-col justify-center">
            ...
            <div className="grid grid-cols-3 gap-4 mb-6 bg-[#0B0E14] p-4 rounded-lg border border-slate-800/50">
              <div className="text-center">
                <div className="text-xs text-slate-500 uppercase tracking-wider mb-1 flex items-center justify-center gap-1">
                  <Eye className="w-3.5 h-3.5" /> 訪問
                </div>
                <div className="text-lg font-bold text-slate-200">{(place.visit_count / 1000000).toFixed(1)}M+</div>
              </div>
              <div className="text-center border-l border-slate-800">
                <div className="text-xs text-slate-500 uppercase tracking-wider mb-1 flex items-center justify-center gap-1">
                  <Heart className="w-3.5 h-3.5" /> いいね
                </div>
                <div className="text-lg font-bold text-slate-200">{(place.favorite_count / 1000).toFixed(1)}K+</div>
              </div>
              <div className="text-center border-l border-slate-800">
                <div className="text-xs text-slate-500 uppercase tracking-wider mb-1 flex items-center justify-center gap-1">
                  <Users className="w-3.5 h-3.5" /> プレイ中
                </div>
            ...
            <div className="flex flex-col gap-3">
              <div className="flex gap-3">
                <a
                  ...
                  className="flex-1 text-center bg-green-600 hover:bg-green-500 text-white font-bold py-3 px-8 rounded-xl transition-all shadow-lg shadow-green-900/20 transform hover:-translate-y-0.5 flex items-center justify-center gap-2"
                >
              ...
              <a
                href="#review-form"
                className="w-full text-center py-2.5 px-4 bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white rounded-xl transition-colors text-sm font-medium border border-slate-700 flex items-center justify-center gap-2"
              >
